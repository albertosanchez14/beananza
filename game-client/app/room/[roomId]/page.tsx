  ...
  const {
    ...
    onMessage: (message) => {
      ...
      if (message.type === "error") {
        const errorPayload = message.payload as unknown as { code: string; message: string };
          ...
          <div className="flex flex-col items-center justify-center flex-1 gap-6 text-center">
            <div className="flex flex-col items-center gap-3">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 max-w-xs">
                Room <span className="font-semibold text-gray-700 dark:text-gray-300">{roomId}</span> already has a game running. You cannot join until the current game ends.
              </p>
            </div>
            <button
