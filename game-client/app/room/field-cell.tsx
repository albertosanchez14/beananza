...
export default function FieldCell({
    ...
    return (
      <div
        ...
        className={`w-full h-full rounded flex flex-col items-center 
					...
					border-[rgba(185,148,90,0.35)] bg-[rgba(210,175,110,0.05)] 
					[box-shadow:inset_0_2px_8px_rgba(0,0,0,0.10)] 
					${interactive ? "group cursor-pointer hover:border-[rgba(210,170,90,0.65)] hover:bg-[rgba(200,160,80,0.13)] hover:[box-shadow:inset_0_2px_8px_rgba(0,0,0,0.10),0_0_10px_2px_rgba(255,255,255,0.08)]" : "opacity-40 cursor-not-allowed"}`}
      >
        {interactive && (
    ...
    return (
      <div
        className="w-full h-full rounded flex flex-col items-center justify-center gap-0.5 
			border-2 border-[#b84010] bg-[rgba(80,18,5,0.68)] shadow-[0_0_12px_2px_rgba(184,64,16,0.55)]"
      >
        ...
        <button
          disabled
          className="mt-0.5 px-2 py-0.5 rounded font-semibold text-orange-300 border 
					border-orange-700 cursor-not-allowed opacity-60 text-[clamp(0.45rem,0.8vw,0.65rem)]"
        >
          Watch
        </button>
      </div>
  ...
  return (
    <div
      className="w-full h-full rounded flex flex-col items-center justify-center gap-0.5 
		border-2 border-[#d4903a] bg-[rgba(65,32,5,0.62)] shadow-[0_0_14px_3px_rgba(212,144,58,0.55)]"
    >
      ...
      <button
        ...
        disabled={!canJoin}
        className="mt-0.5 px-2 py-0.5 rounded font-bold text-stone-900 bg-amber-500 
